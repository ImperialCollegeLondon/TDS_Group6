...
for n_clusters in range(2, 11):
    kmeans = KMeans(n_clusters=n_clusters)
    cluster_labels = kmeans.fit_predict(traino[cols_to_scale])
    silhouette_avg = metrics.silhouette_score(traino[cols_to_scale], cluster_labels)
...
#testo['KMeans_cluster'] = testo_kmeans
